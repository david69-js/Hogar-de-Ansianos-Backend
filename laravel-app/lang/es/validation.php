...
/*
 * Mensajes de validación en español. La app muestra tal cual el primer error
 * que devuelve la API (p. ej. create-resident.tsx), así que sin este archivo
 * el personal veía "The birth date field is required.". Las llaves son las de
 * vendor/laravel/framework/src/Illuminate/Translation/lang/en/validation.php;
 * `attributes` traduce el nombre de cada campo que aparece en :attribute.
 */
return [
    ...
    'in_array_keys' => 'El campo :attribute debe contener al menos una de estas llaves: :values.',
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute ingresado apareció en una filtración de datos. Elige otro.',
    ],
    ...
    // Cómo se nombra cada campo en los mensajes (":attribute"). Si un campo no
    // está aquí, Laravel usa su nombre técnico con espacios ("birth date").
    'attributes' => [
        // Personas
        ...
        'recorded_at' => 'fecha de toma',
        'disease_id' => 'condición',
        'diagnosed_at' => 'fecha de diagnóstico',
        // Medicamentos, prescripciones y dosis
        'name' => 'nombre',
        'description' => 'descripción',
        'dosage_form' => 'presentación',
        ...
        'administered_time' => 'hora de administración',
        'administered_by' => 'responsable',
        'reason_for_omission' => 'motivo de omisión',
        'incident_type' => 'tipo de incidencia',
        // Filtros de reportes y listados
        'period' => 'periodo',
        'date' => 'fecha',
        'from' => 'fecha inicial',
        'to' => 'fecha final',
        'with_treatment' => 'con tratamiento',
        'platform' => 'plataforma',
    ],
