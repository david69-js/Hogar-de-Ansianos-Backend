...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                /*
                 * Deliberadamente vacío: solo respaldamos la base de datos, no el
                 * código ni los archivos subidos. El código vive en git; las fotos
                 * y documentos de residentes ya viven en Cloudflare R2 (que tiene
                 * su propia redundancia) — duplicarlos aquí solo desperdiciaría
                 * espacio. Si algún día hace falta un respaldo de archivos también,
                 * agrégalos aquí explícitamente.
                 */
                'include' => [],
        ...
        'destination' => [
            ...
            /*
             * El mismo disco R2 que ya se usa para fotos/documentos de
             * residentes (config/filesystems.php) — sin credenciales nuevas.
             * Los backups quedan aparte, bajo el prefijo `backups/` (ver
             * `name` arriba), no mezclados con esos archivos.
             */
            'disks' => [
                'r2',
            ],
    ...
    'notifications' => [
        ...
        'mail' => [
            // Define BACKUP_NOTIFICATION_EMAIL en .env con el correo real que debe
            // recibir estos avisos (falla de backup, backup viejo/faltante, etc.).
    ...
    'monitor_backups' => [
        [
            ...
            'health_checks' => [
                ...
                // evita un falso positivo si el comando corrió unos minutos tarde.
    ...
    'cleanup' => [
        ...
        // Política elegida: diario durante 14 días, luego uno mensual por 6 meses más.
        'default_strategy' => [
            /*
